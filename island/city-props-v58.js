...
import {mergeGeometries} from '/67park-kimi-best/island/utils/BufferGeometryUtils.js';
...
export async function loadCityProps58({scene,renderer,sample,variant}){
 ...
 const [buildings,bridge,layout,bridgeMeta]=await Promise.all([
  loader.loadAsync('/67park-kimi-best/island/city-buildings-v58.glb?v=1'),loader.loadAsync('/67park-kimi-best/island/city-bridge-v58.glb?v=1'),

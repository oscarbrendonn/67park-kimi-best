...
import {applyKimiCoast20} from '/67park-kimi-best/app/kimi-coast20.js?v=coast-24';
import {cleanLowerPark} from '/67park-kimi-best/app/park-lower-cleanup.js?v=20260914p';
import {repairEastRoadEnd} from '/67park-kimi-best/app/east-road-end.js?v=corner-49b';
import {installLobbyCourts} from '../app/lobby-courts.js';
import {shortenKimiRightTip} from '/67park-kimi-best/app/kimi-right-curb-tip.js?v=coast-20a';
import {installIslandSwimBoundary} from '/67park-kimi-best/app/island-swim-runtime.js?v=fleet-38';
import {installParcelGapQA} from '/67park-kimi-best/app/parcel-gap-qa.js';
import {applyParcelPaving} from '/67park-kimi-best/app/island-parcel-paving.js';
import {installParcelCornerQA} from '/67park-kimi-best/app/parcel-corner-qa.js';
import {assetFetch} from '/67park-kimi-best/app/entry-loading.js';
const islandFetch=(u,...a)=>assetFetch(typeof u==='string'&&u.startsWith('./')?'/67park-kimi-best/island/'+u.slice(2):u,...a);
...
import {repairIslandStairs,stairAt,stairsRailBlocked} from '/67park-kimi-best/app/island-stair-geometry.js';
import {applyCurbJoins} from '/67park-kimi-best/app/island-curb-joins.js';
import {applyParkEdges} from '/67park-kimi-best/app/island-park-edges.js';
...
import {shortenSoutheastDivider49} from '/67park-kimi-best/app/southeast-divider-49.js?v=corner-49b';
...
import {entryStage} from '/67park-kimi-best/app/entry-loading.js';
...
const GLB_DOSYASI=urlParams.get('model')==='pending'
  ...
  : '/67park-kimi-best/island/ada_calisma.glb';
